...
namespace Foody.Controls
{
  public class RecipeList : UserControl
  {
    ...
    {
      this.MainListPanel.Controls.Remove((Control) this.recipeControl);
    ...
    {
      this.recipeControl = new RecipeControl(idx);
      this.recipeControl.Dock = DockStyle.Fill;
      this.recipeControl.GoBack += new Delegates.Back(this.BackHere);
      this.MainListPanel.Controls.Remove((Control) this.RecipesCtrlStaffs);
      this.MainListPanel.Controls.Add((Control) this.recipeControl);
    }

    private void RecipeEditorForNewCreation()
    {
      this.recipeControl = new RecipeControl(-1, true);
      this.recipeControl.Dock = DockStyle.Fill;
      this.recipeControl.GoBack += new Delegates.Back(this.BackHere);
      this.recipeControl.Visible = true;
      this.MainListPanel.Controls.Remove((Control) this.RecipesCtrlStaffs);
      this.MainListPanel.Controls.Add((Control) this.recipeControl);
    }
